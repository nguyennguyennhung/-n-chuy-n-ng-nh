...
{
    [Header("Tham chiếu")]
    public HandGestureInteraction gestureController;
    ...
    void FireButton(int index)
    {
        switch (index)
        {
            case 0: gestureController.InvokeToggleTransparency(); break;  // #5
            case 1: gestureController.InvokeToggleWireframe();    break;  // #6
            case 2: gestureController.InvokeToggleVertexLabels(); break;  // #7
            case 3: gestureController.InvokeToggleEdgeLabels();   break;  // #8
        }
    }
